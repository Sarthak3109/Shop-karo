...
import {
  ...
  stateofProducts,
  totalNumberOfItems,
  selectAllBrands,selectAllCategories, fetchAllBrandsAsync, fetchAllCategoriesAsync
...
export default function ProductList() {
  ...
  const filters = [
    {
      id: 'category',
      name: 'Category',
      options: CATEGORIES_FROM_BACKEND
    },
    {
      id: 'brand',
      name: 'Brands',
      options: BRANDS_FROM_BACKEND,
    },
  ];
  ...
  useEffect(() => {
    ...
    console.log(BRANDS_FROM_BACKEND)
  }, [dispatch]);
                                ...
                                {section.options.map((option, optionIdx) => (
                                  ...
                                  >
                                    <input
                                      ...
                                      onClick={e => handleFilter(e, section.id)}
                                    />
                                    <label
